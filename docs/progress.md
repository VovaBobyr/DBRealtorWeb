...
- [x] Schema reference to `C:\Git\DBRealtor\docs\architecture.md`
...
- [x] `nginx/nginx.conf` — /api/ → backend:8000, / → frontend:5173 (with WS for HMR)
- [x] `docker-compose.yml` — db, backend, frontend, nginx services
- [x] `.env.example`
- [x] `.gitignore`
- [x] `frontend/Dockerfile` — multi-stage build for production
